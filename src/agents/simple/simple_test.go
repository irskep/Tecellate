...
func TestWith2Coord_2Agents(t *testing.T) {
    ...
    gameconf := coord.NewGameConfig("noise", true, true, 10, 10)
    gameconf.AddAgent(makeAgent(1, geo.NewPoint(0, 0), 1))
    gameconf.AddAgent(makeAgent(2, geo.NewPoint(0, 1), 1))
    gameconf.AddAgent(makeAgent(3, geo.NewPoint(1, 1), 0))
    gameconf.AddAgent(makeAgent(4, geo.NewPoint(2, 1), 1))
    gameconf.AddAgent(makeAgent(5, geo.NewPoint(3, 1), 2))
